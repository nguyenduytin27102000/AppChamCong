...
namespace TimeKeeping.Controllers
{
    ...
    {
        private readonly TimeKeepingDB5Context _context = new TimeKeepingDB5Context();
        ...
        public async Task<IActionResult> AddOrEdit(string id, [Bind("FormTimeOffId,FormTimeOffName,TypeTimeOffId,RequireApproval,ApprovalProcessId,RequireLimitedDaysOff,ProcessingTime,NumberOfDaysBeforeTimeOff,LimitedDaysOff,Regulations,Active")] FormTimeOff formTimeOff)
        {
